<div class="row">
  <div class="col-md-8 col-md-offset-2 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>AJOUT DE PRODUIT <small>Formulaire relatif à l'ajout d'un nouveau Produit</small></h2>
      ...
      <div class="x_content">
        ...
        <form class="form-horizontal form-label-left input_mask" method="post" action="__controlElement">
          ...
          <?= $form->input('nom', 'recycle', 'text', '', '', $nom, "Nom du Produit"); ?>
          <?= $form->input('description', 'pencil', 'text', '', '', $description, 'Description'); ?>
          <?= $form->input('prix', 'money', 'number', '', '', $prix, 'Prix d Achat'); ?>
          
          <div class="ln_solid"></div>
          <div class="form-group">
            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
              <?php $action = isset($old) ? 'Modifier' : 'Ajouter'; ?>
              <?php $name = isset($old) ? 'modProduit' : 'addProduit'; ?>
