<div class="row">
  <div class="col-md-8 col-md-offset-2 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>VENDRE BOISSON<small>Formulaire relatif à la vente d'un Boisson</small></h2>
      ...
      <div class="x_content">
        ...
        <form class="form-horizontal form-label-left input_mask" method="post" action="__sell">
          ...
          <?= $form->input('nom', 'user', 'text', '', '', $nom, "Nom de la Boisson", '', '', 'readonly'); ?>
          ...
          <?= $form->input('prix_vendu', 'money', 'number', '', '', '', 'Prix Vendu', $prix_vente); ?>
